...
///
/// `VideosGridViewController` is a view controller that displays a grid of Moments content.
...
/// https://dev.wsc-sports.com/docs/ios-widgets#/videos-grid
///

class VideosGridViewController: BaseWidgetEditOptionsViewController {
    ...
    override init(viewModel: WidgetsViewModel = WidgetsViewModel(widgetType: .videosGrid)) {
    ...
    private func setMyCustomImageStyle(for imageStyle: inout BlazeWidgetItemImageStyle) {
        ...
        let borderColor = UIColor(hex: "#FF60C9")!
        ...
        imageStyle.gradientOverlay.isVisible = false
    }
    ...
    private func setMyCustomStatusIndicatorStyle(for statusIndicatorStyle: inout BlazeWidgetItemStatusIndicatorStyle) {
        ...
        let backgroundColor = UIColor(hex: "#FFC7F2")!
    ...
    private func setMyCustomTitleStyle(for titleStyle: inout BlazeWidgetItemTitleStyle) {
        ...
        titleStyle.position.yPosition = .bottomToBottom(offset: -8)
    ...
    private func setMyCustomBadgeStyle(for badgeStyle: inout BlazeWidgetItemBadgeStyle) {
        ...
        badgeStyle.position.xPosition = .centerToTrailing(offset: 0)
        badgeStyle.position.yPosition = .centerToTop(offset: 0)
    ...
    private func getBlazeWidgetItemStyleOverrides(newWidgetLayout: BlazeWidgetLayout) -> BlazeWidgetItemStyleOverrides {
        ...
        statusIndicator.insets = .init(top: 8, leading: 8, bottom: 0, trailing: 0)
